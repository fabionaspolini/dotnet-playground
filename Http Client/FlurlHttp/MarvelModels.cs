...
namespace QuickType
{
    ...
    public partial class CharactersResponse
    {
        public static CharactersResponse FromJson(string json) => JsonConvert.DeserializeObject<CharactersResponse>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this CharactersResponse self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
